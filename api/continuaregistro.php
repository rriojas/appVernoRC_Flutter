...
<html lang="en">
  <head>
    ...
    <title>Verano de la ciencia</title>
...
<div class="container py-3">
  <header>
    ...
    <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
      ...
      <p class="fs-5 text-muted">Para continuar con el registro favor de ingresar la siguiente información</p> 
    </div>
  </header>
...
<script src="continuaregistro.js"></script>
  </body>
</html>
